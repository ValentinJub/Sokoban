 ...
 * software surface: call IMG_loadTexturetureTyped_RW() instead.
 *
 ...
 * If you are using SDL's 2D rendering API, there is an equivalent call to
 * load images directly into an SDL_Texture for use by the GPU without using a
 * software surface: call IMG_loadTextureture() instead.
 *
 * When done with the returned surface, the app should dispose of it with a
 * call to SDL_FreeSurface().
 *
 ...
 * If you are using SDL's 2D rendering API, there is an equivalent call to
 * load images directly into an SDL_Texture for use by the GPU without using a
 * software surface: call IMG_loadTextureture_RW() instead.
 *
 * When done with the returned surface, the app should dispose of it with a
 * call to SDL_FreeSurface().
 *
 ...
 * There is a separate function to read files from an SDL_RWops, if you need
 * an i/o abstraction to provide data from anywhere instead of a simple
 * filesystem read; that function is IMG_loadTextureture_RW().
 *
 ...
 * \since This function is available since SDL_image 2.0.0.
 *
 * \sa IMG_loadTexturetureTyped_RW
 * \sa IMG_loadTextureture_RW
 * \sa SDL_DestroyTexture
 */
extern DECLSPEC SDL_Texture * SDLCALL IMG_loadTextureture(SDL_Renderer *renderer, const char *file);
 ...
 *
 * There is a separate function to read files from disk without having to deal
 * with SDL_RWops: `IMG_loadTextureture(renderer, "filename.jpg")` will call this
 * function and manage those details for you, determining the file type from
 * the filename's extension.
 *
 * There is also IMG_loadTexturetureTyped_RW(), which is equivalent to this
 ...
 * \since This function is available since SDL_image 2.0.0.
 *
 * \sa IMG_loadTextureture
 * \sa IMG_loadTexturetureTyped_RW
 * \sa SDL_DestroyTexture
 */
extern DECLSPEC SDL_Texture * SDLCALL IMG_loadTextureture_RW(SDL_Renderer *renderer, SDL_RWops *src, int freesrc);
 ...
 *
 * There is a separate function to read files from disk without having to deal
 * with SDL_RWops: `IMG_loadTextureture("filename.jpg")` will call this function
 * and manage those details for you, determining the file type from the
 * filename's extension.
 *
 * There is also IMG_loadTextureture_RW(), which is equivalent to this function
 ...
 * \sa SDL_DestroyTexture
 */
extern DECLSPEC SDL_Texture * SDLCALL IMG_loadTexturetureTyped_RW(SDL_Renderer *renderer, SDL_RWops *src, int freesrc, const char *type);
#endif /* SDL 2.0 */
