...
int manuelJeu(SDL_Renderer*renderer, TTF_Font*font)
{
	...
	surface = IMG_Load("ResourcesNew/bgintro.png");
	texture = SDL_CreateTextureFromSurface(renderer,surface);
...
void jouer(SDL_Renderer*renderer)
{
	...
	SDL_Texture *textureMur = loadTex(renderer,"/ResourcesNew/mur.png"),
		    *textureVide = loadTex(renderer,"/ResourcesNew/ground_01.png"),
		    *textureCaisse= loadTex(renderer,"/ResourcesNew/box.png"),
		    *textureCaisseOk = loadTex(renderer,"/ResourcesNew/boxOK.png"),
		    *textureObjectif = loadTex(renderer,"/ResourcesNew/objAlt.png");
		    mario[HAUT]= loadTex(renderer,"/ResourcesNew/mario_haut.png");
		    mario[BAS]= loadTex(renderer,"/ResourcesNew/mario_bas.png");
		    mario[GAUCHE]= loadTex(renderer,"/ResourcesNew/mario_gauche.png");
		    mario[DROITE]= loadTex(renderer,"/ResourcesNew/mario_droite.png");
...
void ecranFin(SDL_Renderer*renderer)
{
	...
	surface = IMG_Load("/Resources/PlayAgain.png");
	texture = SDL_CreateTextureFromSurface(renderer,surface);
	SDL_RenderCopy(renderer,texture,NULL,NULL);
	SDL_RenderPresent(renderer);
	SDL_Delay(3000);
